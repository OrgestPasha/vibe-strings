  ...
  return (
    <div class="everything">
      ...
      <div class="brand-container">
        <h2>
          Featuring the Best <span class="colorText">Best Brands</span>
        </h2>
      ...
      <div class="features-container">
        <div class="features-header">
          <h2>
            Why try <span class="colorText">VibeStrings?</span>
          </h2>
          <div class="features">
            <div class="feature">
      ...
      <div class="apps-container">
        <div class="app-left">
          <h1>
            Browse and buy your <span class="colorText">favorite guitars </span>
            with VibeStrings.{" "}
          </h1>
